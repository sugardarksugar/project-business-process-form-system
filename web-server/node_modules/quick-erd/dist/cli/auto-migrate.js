...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const erd = yield new Promise(resolve => file_1.readErdFromStdin(resolve));
        const parseResult = ast_1.parse(erd);
        const srcDir = auto_migrate_1.detectSrcDir();
        let db_client;
        let dbFile;
        switch (dbFile_or_client) {
            ...
            default: {
                ...
                auto_migrate_1.setupSqlite({ srcDir, dbFile });
            }
        }
        auto_migrate_1.setupKnexFile({ srcDir, db_client });
        const knex = dbFile ? knex_1.loadSqliteKnex(dbFile) : knex_1.loadKnex(db_client);
        yield auto_migrate_1.setupKnexMigration({
            knex,
            parseResult,
            db_client,
            detect_rename,
